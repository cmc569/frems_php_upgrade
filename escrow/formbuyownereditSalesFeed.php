...
$certifyDate = empty($_POST["certifyDate"]) //履保費出款日
        ? $_GET["certifyDate"]
        : $_POST["certifyDate"];
...
if ($_POST['cat'] == 'add') {
	...
	$sql = "INSERT INTO tFeedBackMoneyReviewList (
				...
				fFeedbackTarget,
				fFeedbackStoreId,";
if($_POST['cFeedbackTarget_1'] == 2 and $feedbackDataId != 0) {
	$sql .= "fFeedbackDataId,";
}
	$sql .= "fCaseFeedBackMoney
				...
				'".$rid."',
				'1',
				'".$_POST['cCaseFeedback_1']."',
				'".$_POST['cFeedbackTarget_1']."',
				'".$_POST['cFeedbackStoreId_1']."',";
if($_POST['cFeedbackTarget_1'] == 2 and $feedbackDataId != 0) {
	$sql .= "".$feedbackDataId.",";
}
	$sql .= "'".$_POST['cCaseFeedBackMoney_1']."'
		)";
	$conn->Execute($sql);

	if(count($_POST['individualMoney'][$_POST['cFeedbackStoreId_1']]) > 0 )
	{
		foreach ($_POST['individualMoney'][$_POST['cFeedbackStoreId_1']] as $key => $value) {
				//第一間店個案回饋
				$sql = "INSERT INTO tFeedBackMoneyReviewList (
						fCertifiedId,
						fRId,
						...
						'1',
						'3',
						'".$_POST['individualBranchId'][$_POST['cFeedbackStoreId_1']][$key]."',
						'".$_POST['individualId'][$_POST['cFeedbackStoreId_1']][$key]."',
						'".$_POST['individualMoney'][$_POST['cFeedbackStoreId_1']][$key]."'
				);";
			$conn->Execute($sql);
		}
	}
...
if($_POST['cFeedbackTarget_2'] == 2 and $feedbackDataId != 0) {
	...
	$sql .= "'".$_POST['cCaseFeedBackMoney_2']."'
		)";
	$conn->Execute($sql);

	if(count($_POST['individualMoney'][$_POST['cFeedbackStoreId_2']]) > 0 )
	{
		foreach ($_POST['individualMoney'][$_POST['cFeedbackStoreId_2']] as $key => $value) {
			//第二間店個案回饋
			$sql = "INSERT INTO tFeedBackMoneyReviewList (
					fCertifiedId,
					fRId,
					...
					'1',
					'3',
					'".$_POST['individualBranchId'][$_POST['cFeedbackStoreId_2']][$key]."',
					'".$_POST['individualId'][$_POST['cFeedbackStoreId_2']][$key]."',
					'".$_POST['individualMoney'][$_POST['cFeedbackStoreId_2']][$key]."'
			);";
...
if($_POST['cFeedbackTarget_3'] == 2 and $feedbackDataId != 0) {
	...
	$sql .= "'".$_POST['cCaseFeedBackMoney_3']."'
		)";
	$conn->Execute($sql);

	if(count($_POST['individualMoney'][$_POST['cFeedbackStoreId_3']]) > 0 ) {
		foreach ($_POST['individualMoney'][$_POST['cFeedbackStoreId_3']] as $key => $value) {
			//第三間店個案回饋
			$sql = "INSERT INTO tFeedBackMoneyReviewList (
					fCertifiedId,
					fRId,
					...
					'1',
					'3',
					'" . $_POST['individualBranchId'][$_POST['cFeedbackStoreId_3']][$key] . "',
					'" . $_POST['individualId'][$_POST['cFeedbackStoreId_3']][$key] . "',
					'" . $_POST['individualMoney'][$_POST['cFeedbackStoreId_3']][$key] . "'
			);";
...
if($_POST['cFeedbackTarget_6'] == 2 and $feedbackDataId != 0) {
	...
	$sql .= "'".$_POST['cCaseFeedBackMoney_6']."'
		)";
	$conn->Execute($sql);

	if(count($_POST['individualMoney'][$_POST['cFeedbackStoreId_6']]) > 0 ) {
		foreach ($_POST['individualMoney'][$_POST['cFeedbackStoreId_6']] as $key => $value) {
			//第四間店個案回饋
			$sql = "INSERT INTO tFeedBackMoneyReviewList (
					fCertifiedId,
					fRId,
					...
					'1',
					'3',
					'".$_POST['individualBranchId'][$_POST['cFeedbackStoreId_6']][$key]."',
					'".$_POST['individualId'][$_POST['cFeedbackStoreId_6']][$key]."',
					'".$_POST['individualMoney'][$_POST['cFeedbackStoreId_6']][$key]."'
			);";
			$conn->Execute($sql);
		}
...
if($_POST['newotherFeedType'.$i] == 2 and $otherFeedbackDataId != 0) {
	...
	$msg = '申請成功';
	$cat = 'save';
}elseif ($_POST['cat'] == 'save') {
	$sql = "UPDATE
				tFeedBackMoneyReviewList
			SET
				fCaseFeedback = '".$_POST['cCaseFeedback_1']."',
				fFeedbackTarget = '".$_POST['cFeedbackTarget_1']."',
				fFeedbackStoreId = '".$_POST['cFeedbackStoreId_1']."',
				fCaseFeedBackMoney  = '".$_POST['cCaseFeedBackMoney_1']."'
			WHERE
	...
	$sql = "UPDATE
				tFeedBackMoneyReviewList
			SET
				fCaseFeedback = '".$_POST['cCaseFeedback_2']."',
				fFeedbackTarget = '".$_POST['cFeedbackTarget_2']."',
				fFeedbackStoreId = '".$_POST['cFeedbackStoreId_2']."',
				fCaseFeedBackMoney  = '".$_POST['cCaseFeedBackMoney_2']."'
			WHERE
	...
	$sql = "UPDATE
				tFeedBackMoneyReviewList
			SET
				fCaseFeedback = '".$_POST['cCaseFeedback_3']."',
				fFeedbackTarget = '".$_POST['cFeedbackTarget_3']."',
				fFeedbackStoreId = '".$_POST['cFeedbackStoreId_3']."',
				fCaseFeedBackMoney  = '".$_POST['cCaseFeedBackMoney_3']."'
			WHERE
	...
	$sql = "UPDATE
				tFeedBackMoneyReviewList
			SET
				fCaseFeedback = '".$_POST['cCaseFeedback_6']."',
				fFeedbackTarget = '".$_POST['cFeedbackTarget_6']."',
				fFeedbackStoreId = '".$_POST['cFeedbackStoreId_6']."',
				fCaseFeedBackMoney  = '".$_POST['cCaseFeedBackMoney_6']."'
			WHERE
	...
	$sql = "UPDATE 
				tFeedBackMoneyReviewList
			SET
				fCaseFeedBackMoney = '".$_POST['cSpCaseFeedBackMoney']."'
			WHERE
	...
	$sql = "UPDATE tFeedBackMoneyReview SET fNote = '".$_POST['note']."' WHERE fId = '".$rid."'";
	$conn->Execute($sql);
...
//
$spRecall = ($data_case['cScrivenerSpRecall'] + $data_case['cBranchScrRecall'] + $data_case['cBranchScrRecall1'] + $data_case['cBranchScrRecall2'] + $data_case['cBranchScrRecall3']);
$chekcsp = ($spRecall > 0) ? 1 : 0 ;
$feedBackScrivener = $feedBackScrivener + $chekcsp;
	...
	while (!$rs->EOF) {
        if ($rs->fields['fDelete'] == 0) {
            if ($rs->fields['fCategory'] <= 3 || $rs->fields['fCategory'] == 6) { //仲介回饋
				...
				$no = '';
				if($rs->fields['fFeedbackStoreId'] == $store[1]['bId']) $no = 1;
				if($rs->fields['fFeedbackStoreId'] == $store[2]['bId']) $no = 2;
				if($rs->fields['fFeedbackStoreId'] == $store[3]['bId']) $no = 3;
				if($rs->fields['fFeedbackStoreId'] == $store[6]['bId']) $no = 6;
...
$menuTarget = array(1=>'仲介',2=>'地政士');
$menuOTarget = array(1=>'地政士',2=>'仲介');
...
if(count($otherScrivenerAccount) <= 1) {
	$otherScrivenerAccount = [];
}
