...
<div class="price-container">
    <div class="price-content">
        <h3 class="title2">履約價金保證系統  〉 <span>買賣方案件查詢</span> <span class="datetime"><!-- 登入時間 :<?=$ly?>/<?=$lm?>/<?=$ld?> --></span></h3>
            <div class="price-user">
                <div class="price-user-w">親愛的<span><?=$customer?></span>客戶 &nbsp;&nbsp; 您好 : 歡迎蒞臨第一建經 ESCROW 線上作業系統 !<br/>
                        如有任何問題，請洽您的服務人員 <b><?=$list['undertaker']?></b> &nbsp; 聯絡電話 : <?=$company['tel']?> *(<?=$list['ext']?>) &nbsp;&nbsp; 傳真號碼 : <?=$company['fax']?>
                </div>
            </div><!--price-user-->
                ...
                <div class="div-tables">
                    ...
                    <tbody>
                        <tr class="tr_th">
                            ...
                            <td width="15%" class="td_2"><?=$list['undertaker']?></td>
                            <th colspan="2" class="th_1">案件狀態</th>
                            <td width="15%" class="td_2"><?=$data_case['cCaseStatus']?></td>
                            <th class="th_1">簽約日期</th>
                            <td width="15%" class="td_3"><?=substr($data_case['cSignDate'], 0, 10)?></td>
                        </tr>
                        <tr class="tr_th">
                            <th class="th_1">保證號碼</th>
                            <td colspan="3" class="td_2"><?=$data_case['cCertifiedId']?></td>
                            <th class="th_1" nowrap>專屬帳號</th>
                            <td colspan="2" class="td_2"><?=$data_case['cEscrowBankAccount']?></td>
                        </tr>
                        <tr class="tr_th">
              ...
              <section class="e-table">
               ...
               <?php endif ?>
                ...
                <!--b-form01-33--> 
                  ...
                  <h3>注意事項 : </h3>
                  <p>1. 上列資料若有疑問，請儘速與第一建經服務人員聯繫，服務專線 : <?=$company['tel']?>，我們將竭誠為您服務。<br/>
