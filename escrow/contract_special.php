...
<input type="hidden" name="cCertifyId" value="<?=$vr_code?>">
...
<table border="0" style="width:1000px;">
	...
	<tr>
		<td colspan="6" style="background-color:#E4BEB1;font-size:12pt;font-weight:bold;padding:5px;">
			<span class="sign-red">*</span>特約事項<?=$count?>&nbsp;&nbsp;(<?=$cCertifiedId?>)
	...
	<tr>
		...
		<td style="width:380px;">
			<table border="0" style="width:300px;">
				<tr>
					<td>
						<input type="hidden" name="cIdentity" value="<?=$cCertifiedId?>">
						
						<textarea name="cNote" cols="50" rows="10"><?=$rs->fields['cNote']?></textarea>
					</td>
				</tr>
